...
import { CreditCard, TrendingUp, TrendingDown, Edit3, Save, X, ChevronDown } from 'lucide-react';
...
export const PaymentMethodMonthOnMonthTable: React.FC<PaymentMethodMonthOnMonthTableProps> = ({
  ...
  const processedData = useMemo(() => {
    ...
    return paymentMethodData.sort((a, b) => b.totalRevenue - a.totalRevenue);
  }, [data, monthlyData]);
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Monthly performance metrics by payment method
              </p>
            </div>
